        ...
        <div class="border-right" id="sidebar-wrapper">
          ...
          <div class="list-group list-group-flush">
            ...
            <a
              ...
              class="list-group-item list-group-item-action {{ request()->is('admin/transaction') || request()->is('admin/transaction/{id}/edit') ? 'active' : '' }}"
            >
              Transactions
            </a>
            <a
              href="{{ route('detail.index') }}"
              class="list-group-item list-group-item-action {{ request()->is('admin/detail*')  ? 'active' : '' }}"
            >
